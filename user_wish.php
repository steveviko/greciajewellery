...
<?php
		...
		<div class="sellers_grid">
			<ul class="sellers">
				<i class="star"> </i>
				<li class="sellers_desc"><h2>Your Wish List</h2></li>
				<div class="clearfix"> </div>
			</ul>
		</div>
      ...
      <table class="table table-striped b-t b-light">
		...
		// $cart_count variable is initialized in navigation.php
		  ...
		  <td></td>
            ...
            <td><span class="text-ellipsis"><?php echo $description ?></span></td>
		...
		// no products were added to cart
			...
			echo "<div class='col-md-12'>";
				echo "<div class='alert alert-danger'>";
					echo "No products found in Your Wishists!";
				echo "</div>";
			echo "</div>";
		}
