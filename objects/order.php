...
class Order{
    ...
    function create(){
        ...
        $query = "INSERT INTO
               ...
               SET name=:name, price=:price, description=:description,
						category_id=:category_id, image=:image, secondimage=:secondimage,thirdimage=:thirdimage, created=:created";
        ...
        if($stmt->execute()){
			...
			$query = "SELECT
						id, user_id,status,name, products,phone,address,AreaZone,created, total_amount, user_id,no_of_orders
					FROM
						" . $this->table_name . "
					ORDER BY
						name ASC
	...
	public function readUserOrder(){
	 
		$query="SELECT 
				id, user_id,status,name, products,phone,address,created, total_amount
		...
		function readOne(){
				...
				$query = "SELECT
							id, user_id,status,name, products,phone,address,AreaZone,created, total_amount,no_of_orders
						FROM
							" . $this->table_name . "
						WHERE
							id = ?
				...
				$this->AreaZone = $row['AreaZone'];
				$this->created = $row['created'];
				$this->total_amount = $row['total_amount'];
				$this->no_of_orders = $row['no_of_orders'];
			}
	...
	// delete the product
		...
		function readPick($from_record_num, $records_per_page){
			$from_record_num = 0;
			$records_per_page =4;
			// select all products query
			$query = "SELECT
